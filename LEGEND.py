...
bot = telebot.TeleBot('7723459904:AAFUv8na6B7AcnQv-RAOJ_ExrXL6_WBTafo')
...
GROUP_ID = "-1002381814806"
CHANNEL_USERNAME = "https://t.me/+a70zRbaqLa40MWU9"
...
def handle_attack(message):
    ...
    if not is_user_in_channel(user_id):
        bot.reply_to(message, f"❗ **𝐏𝐀𝐇𝐋𝐄 𝐉𝐎𝐈𝐍 𝐊𝐑𝐎** {feedbackOFaayuXddos} 🔥")
        return
    ...
    remaining_attacks = ATTACK_LIMIT - user['attacks'] - 100
    ...
    try:
        ...
        if user_status not in ['member', 'administrator', 'creator']:
            bot.reply_to(message, f"❌ **𝐘𝐨𝐮 𝐌𝐔𝐒𝐓 𝐉𝐎𝐈𝐍 𝐎𝐔𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐅𝐈𝐑𝐒𝐓!**\n"
                                  f"🔗 **𝐉𝐨𝐢𝐧 𝐇𝐞𝐫𝐞:** [Click Here](https://t.me/feedbackOFaayuXddos{CHANNEL_USERNAME})")
            return  
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/+a70zRbaqLa40MWU9) 🚀🔥"""
